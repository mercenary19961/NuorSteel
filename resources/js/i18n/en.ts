const en = {
  ...
  about: {
    hero: {
      title: "About Us",
      subtitle: "Learn more about Nuor Steel Industry Company",
    },
    overview: {
  ...
  products: {
    hero: {
      title: "Our Products",
      subtitle: "High-quality steel products for every need",
    },
  ...
  career: {
    ...
    notFound: "Job listing not found",
    ...
    form: {
      ...
      cvPdfOnly: "CV must be a PDF file",
      cvTooLarge: "CV must be less than 5MB",
  ...
  contact: {
    ...
    form: {
      ...
      fileHint: "PDF, JPG, or PNG, max 5MB",
      fileInvalidType: "Only PDF, JPG, and PNG files are allowed",
      submit: "Send Message",
      sending: "Sending...",
  ...
  footer: {
    ...
    newsletterDescription: "Subscribe for the latest updates.",
