...
export default function ApplicationsPage() {
  ...
  const handleStatusChange = async (
    ...
    try {
      await updateMutation.mutateAsync({ id, status, admin_notes: notes || undefined });
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        {data?.meta && (
          <span className="text-sm text-gray-500 ml-auto">{data.meta.total} applications</span>
        )}
      </div>
      ...
      <DataTable
        ...
        actions={(item) => (
          <>
            ...
            <a
              href={`${import.meta.env.VITE_API_URL || 'http://localhost:8000/api/v1'}/admin/applications/${item.id}/cv`}
              target="_blank"
